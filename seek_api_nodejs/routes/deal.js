...
db = new Db('dealdb', server);

db.open(function(err, db) {
    if(!err) {
        console.log("Connected to 'dealdb' database");
        db.collection('deal', {strict:true}, function(err, collection) {
            if (err) {
                console.log("The 'deal' collection doesn't exist. Creating it with sample data...");
                populateDB();
            }
        });
    }
...
exports.findById = function(req, res) {
    ...
    db.collection('deal', function(err, collection) {
